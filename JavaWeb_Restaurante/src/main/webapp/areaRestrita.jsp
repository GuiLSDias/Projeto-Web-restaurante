...
<head>
    ...
    <style>
        /* Estilos b?sicos para o corpo da p?gina */
        * {
...
<body>
    ...
    <div class="menuCentral">
        ...
        <a href="${pageContext.request.contextPath}${URL_BASE}/CadastroUser?opcao=encaminharParaPagina" class="botaoMenu">Usuario</a>
        <a href="${pageContext.request.contextPath}/login" class="botaoMenu">Logout</a>
    </div>
